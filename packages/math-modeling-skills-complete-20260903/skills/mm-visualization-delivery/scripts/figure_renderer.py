#!/usr/bin/env python3
# Derived from the ARIS FigureSpec renderer at commit
# 94d8093ed21d20a790830318190095b9f5036ce8.
# Copyright (c) 2026 wanshuiyin. Licensed under the MIT License.
# See references/github_derivation_notice.md and the full ARIS MIT license in
# math-modeling-orchestrator/references/aris-derived/ARIS_MIT_LICENSE.txt.
"""
